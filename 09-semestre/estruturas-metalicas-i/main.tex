...
\begin{enumerate}
    ...
    \textcolor{gray}{$\lambda_r = \frac{1,38 c_b \sqrt{I_yJ}}{r_y \times J \times B_y} \sqrt{1+ \sqrt{\frac{1+27C_w B_1^2}{C_b^2}}}$}

    \textcolor{gray}{$B_1 = \frac{(f_y - \sigma_r)W}{EJ}$}

    \textcolor{gray}{$C_w = \frac{I_y(d-t_y)^2}{4} \ \text{Para seções I}$}

    \textcolor{gray}{$C_b = \frac{12,5 M_{max}}{2,5M_{max}+3M_A+4M_B+3M_C}R_m \to R_M =1$}
