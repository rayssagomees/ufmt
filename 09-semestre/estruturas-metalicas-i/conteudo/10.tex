...
\begin{enumerate}
    ...
    \input{assets/images/diagrama-cortante.tex}

    \textcolor{gray}{$V_{Sd,max} = V_A = 6224 \ kN$}

    \input{assets/images/diagrama-momento.tex}
    ...
    \textcolor{gray}{\textbf{\MakeUppercase{Terceira tentativa}}}

    \textcolor{gray}{Perfil VS 900 x 177}

    \textcolor{gray}{$\lambda = \frac{h}{t_w} = \frac{85,5 \ cm}{0,8 \ cm} = 106,875$}

    \textcolor{gray}{$\lambda_p = 1,1 \sqrt{\frac{K_v \cdot E}{f_y}} \to K_v = 5,34 \newline \lambda_p = 60,76$}

    \textcolor{gray}{$\lambda_r = 1,37 \sqrt{\frac{k_v \cdot E}{f_y}} = 75,67$}

    \textcolor{gray}{$\lambda > \lambda_r$}

    \textcolor{gray}{$V_{Rd} = 1,24 (\frac{\lambda_p}{\lambda})^2 \frac{V_{pl}}{\gamma_{a1}} = 1,24 (\frac{60,76}{106,875})^2 \frac{1511,66}{1,1} = 550,76 \ kN$}

    \textcolor{gray}{$V_{pl} = 0,6 A_w f_y = 1511,66 \ kN$}

    \textcolor{gray}{$A_w = d \cdot t_w = (h_0 2t_f)t_w = 71,984 \ cm$}

    \textcolor{gray}{$V_{Sd} > V_{Rd} \to$ não suporta.}

    \textcolor{gray}{$\frac{a}{h}>3 \newline a = 3,1 \cdot h = 2,9 \times 85,5 \newline 265 \ cm$}

    \textcolor{gray}{$k_v = 5+\frac{5}{(a/h)^2} = 5 + \frac{5}{(265/85,5)^2} = 5,52$}

    \textcolor{gray}{$k_v = 5+\frac{5}{(a/h)^2} = 5 + \frac{5}{(100/85,5)^2} = 8,65$}

    \textcolor{gray}{$\lambda_p = 77,33$}

    \textcolor{gray}{$\lambda_r = 96,31$}

    \textcolor{gray}{$V_{Rd} = 892,127 \ kN$}

    \textcolor{gray}{$0,56 \sqrt{\frac{E}{f_y}}$}
