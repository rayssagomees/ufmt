...
\begin{figure}[htb]
    ...
    \caption{Microscopia Eletrônica de Varredura (MEV) do solo com teor de cimento = 6\% (ampliação de 1000x).}
...
\begin{figure}[htb]
    \centering
    \label{fig:mev-solo-cimento}
    \caption{Imagens de MEV do solo tratado com cimento após 28 dias de cura.}
